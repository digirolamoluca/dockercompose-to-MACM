#inserire nome del file docker-compose (senza estensione). Il file docker-compose dovrà trovarsi nella stessa directory in cui è presente il generator_cypher
